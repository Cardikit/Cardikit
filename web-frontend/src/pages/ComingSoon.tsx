            ...
            <div className="flex flex-col items-center px-6 pt-10 pb-12 flex-1">
                ...
                <div className="w-full bg-[#FBFBFB] rounded-t-4xl flex flex-col items-center flex-1 px-6 py-10 mt-8 shadow-lg">
                    <div className="w-full max-w-md text-center space-y-4">
                        <p className="text-sm uppercase tracking-[0.2em] text-gray-400 font-semibold">Coming Soon</p>
                        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 font-inter">This feature is on its way</h1>
                        <p className="text-gray-600 font-inter">
                            We’re putting the final touches on this experience. Check back shortly while we finish things up.
                        </p>
                    </div>
