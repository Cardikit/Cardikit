            ...
            <DrawerContent className="bg-gray-100 px-6 py-4">
                ...
                <div className="w-full">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-lg font-semibold font-inter text-gray-800">{title}</h2>
                        <input
                            ref={inputRef}
                            type="file"
                        ...
                        <button
                            ...
                            className="w-full bg-white border border-gray-300 rounded-lg py-3 text-center cursor-pointer hover:bg-gray-50 font-inter"
                        >
                            Upload image
                        </button>
                        {allowClear && (
                            <button
                                type="button"
                                onClick={onRemove}
                                className="w-full bg-white border border-red-400 text-red-600 rounded-lg py-3 text-center cursor-pointer hover:bg-red-50 font-inter"
                            >
                                Remove image
                            </button>
                        )}
