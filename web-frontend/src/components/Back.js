...
const Back = () => {
    ...
    */
    ...
    return (_jsx("button", { className: "absolute top-4 left-4 text-[#1E1E1E] bg-[#FBFBFB] p-2 rounded-full shadow-md cursor-pointer", onClick: handleBack, children: _jsx(IoMdArrowBack, { className: "text-2xl" }) }));
};
export default Back;
